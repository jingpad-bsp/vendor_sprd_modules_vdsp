...
extern "C" {
	...
	void* sprd_depth_vdsp_Init(struct depth_init_inputparam *inparam , struct depth_init_outputparam *outputinfo,depth_mode mode,outFormat format);

	int sprd_depth_vdsp_Run(void*handle , void * a_pOutDisparity, void * a_pInMaptable,void* a_pInSub_YCC420NV21,void* a_pInMain_YCC420NV21,weightmap_param *wParams);

	int sprd_depth_vdsp_Close(void *handle);
#endif
